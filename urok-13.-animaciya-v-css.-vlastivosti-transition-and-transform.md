...
{% hint style="info" %}
Не рекомендується анімувати нечислові значення, яак як результат може бути непередбачуваним. Також не рекомендується створювати ключові кадри для значень властивостей, які не мають середньої точки, наприклад: для значень властивості color: pink і color: \#ffffff, width: auto і width: 100px або border-radius: 0 і border-radius: 50% \(в такому випадку краще вказати border-radius: 0%;\).
{% endhint %}
